...
export function seedMessages(): InboundMessage[] {
  ...
  return [
    ...
    },
    {
      ...
      channel: "email",
      subject: "Consulting package — budget question",
    ...
    },
    {
      ...
      customer_id: "cus_kai",
      channel: "email",
      subject: "AI customer support build — $8k budget",
      body: "I run a fast-growing DTC brand and need help building an AI customer support workflow. Budget is around $8k. Are you available next week?",
      received_at: mk(3),
      status: "new",
      amount_hint: 8000,
    },
    {
      ...
      channel: "email",
      subject: "No response — three times now",
      body: "I've emailed three times and nobody has answered. This is ridiculous.",
      received_at: mk(4),
      status: "new",
      amount_hint: null,
    },
